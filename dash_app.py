...
cc = ChartCreator('prepared_dataset.xlsx')  # Generate all the charts
...
main_page_layout = html.Div([
    ...
    dbc.Row([
        dbc.Col([create_graph_card('assets/graph1.png',
        ...
        dbc.Col([create_graph_card('assets/graph2.png',
